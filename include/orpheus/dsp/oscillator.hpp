...
private:
  ...
  // Atomic parameters are initialized in the constructors to avoid MSVC warnings
  // about double literals in in-class initializers when /WX is enabled.
  ...
  void initialize_defaults(double sample_rate) noexcept;
};
