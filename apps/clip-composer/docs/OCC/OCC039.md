...
sn_filename: "OCC039-c7dbcbb7.txt"
prefix: occ
...
### Rules
 ...
 Edit Dialog controls the **MAIN playback** (not a separate stream) 

 Edit a **STOPPED** clip    

 Edit Dialog uses **Cue Buss 1** for preview                        

 Multiple Edit Dialogs open 

 Each gets its own Cue Buss (Cue Buss 1, 2, 3, ...)                 

 Cue Buss routing           

 Default: Sum to main output. Future: Route to headphones           
