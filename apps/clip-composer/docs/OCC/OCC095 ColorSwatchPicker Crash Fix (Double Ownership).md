...
sn_filename: "OCC095 ColorSwatchPicker Crash Fix (Double Ownership)-6fdf0304.txt"
prefix: occ
...
1. **Removed storage in m_popupHolder** (line 238):
...
1. **Removed hideColorPopup() call from lambda** (line 231):
...
1. **Simplified hideColorPopup()** (line 250):
...
1. **Removed m_popupHolder member** (line 74):
