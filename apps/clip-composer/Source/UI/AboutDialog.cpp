...
AboutDialog::AboutDialog() {
  ...
  m_versionLabel.setFont(juce::Font(14.0f));
  ...
  m_buildLabel.setFont(juce::Font(11.0f));
  ...
  m_copyrightLabel.setFont(juce::Font(12.0f));
  ...
  m_creditsLabel.setFont(juce::Font(11.0f));
