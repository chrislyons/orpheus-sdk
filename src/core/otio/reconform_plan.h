...
using ReconformOperationData =
    std::variant<ReconformInsert, ReconformDelete, ReconformRetime>;
...
ORPHEUS_API void SaveReconformPlanToFile(const ReconformPlan &plan,
