...
orpheus_status SessionRemoveTrack(orpheus_session_handle session, orpheus_track_handle track) {
...
const orpheus_session_api_v1 kSessionApiV1{
    ORPHEUS_SESSION_CAP_V1_CORE, &SessionCreate,   &SessionDestroy,          &SessionAddTrack,
