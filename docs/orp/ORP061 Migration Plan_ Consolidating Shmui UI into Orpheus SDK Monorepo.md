...
sn_filename: "ORP061 Migration Plan_ Consolidating Shmui UI into Orpheus SDK Monorepo-cc2c22ba.txt"
prefix: orp
...
1. **API and Component Prop Adjustments:**
...
1. **ElevenLabs CLI / Component Registry Deprecation:**
...
1. **Build and Installation Process Changes:**
...
1. **Removal or Deprecation of Redundant Components/Features:**
...
1. **License and Attribution Changes:**
...
1. **Props and API Changes Codemod** – *updateProps.ts*:
...
1. **Remove Deprecated Usage Codemod** – *removeDeprecated.ts*:
...
1. **Internal Adapter Extraction (if needed)**:
...
1. **CLI Workflow Migration Script**:
