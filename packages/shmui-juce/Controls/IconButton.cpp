...
//==============================================================================
IconButton::IconButton(IconType icon) : m_icon(icon) {}

IconButton::IconButton(IconType icon, ButtonStyle style) : m_icon(icon) {
  setStyle(style);
}
...
//==============================================================================
void IconButton::paintContent(juce::Graphics& g, juce::Rectangle<float> bounds,
