...
//==============================================================================
void TextButton::paintContent(juce::Graphics& g, juce::Rectangle<float> bounds,
                              juce::Colour foregroundColor) {
  const float fontSize = getFontHeightForButton(getButtonSize());
  const float iconSize =
      getIconSizeForButton(getButtonSize()) * 0.75f; // Slightly smaller icons for text buttons
  const float iconGap = 6.0f;
...
//==============================================================================
IconTextButton::IconTextButton(IconType icon, const juce::String& text) : TextButton(text) {
  setLeadingIcon(icon);
}
