...
public:
    ...
    int getNumGroups() const { return static_cast<int>(m_groups.size()); }
    bool hasMaster() const { return m_master != nullptr; }
...
private:
    ...
    void drawLabel(juce::Graphics& g, juce::Rectangle<int> area,
