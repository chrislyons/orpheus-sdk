...
TEST(RenderFilenameRules, FormatsSampleRateAndBitDepth) {
  const std::string filename =
      MakeRenderStemFilename("Project", "Drums", 44100, 24);
