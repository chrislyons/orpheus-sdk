...
bool testAppearanceProfiles() {
  ...
  constexpr std::array<Expected, 6> expected{{
      {Flavor::Console,
       Mode::Light,
       {0xFFB9C1B7, 0xFFC8CEC5, 0xFFD8DDD5, 0xFFA7B0A6, 0xFF909B91},
       Texture::enamelSpeckle,
       0.045f,
       3.0f},
      {Flavor::ConsoleWarm,
       Mode::Light,
       {0xFFC8B894, 0xFFD4C5A4, 0xFFE1D5B9, 0xFFB7A47F, 0xFFA08F71},
       Texture::moldedABS,
       0.075f,
       18.0f},
      {Flavor::ConsoleCool,
       Mode::Light,
       {0xFFBFC3C1, 0xFFCED1CF, 0xFFDDE0DE, 0xFFA9AEAD, 0xFF919797},
       Texture::brushedAluminum,
       0.055f,
       2.0f},
      {Flavor::Console,
       Mode::Dark,
       {0xFF0A1518, 0xFF0F1F23, 0xFF17292F, 0xFF1F363C, 0xFF0C1A1E},
       Texture::powderCoat,
       0.040f,
       4.0f},
      {Flavor::ConsoleWarm,
       Mode::Dark,
       {0xFF16120E, 0xFF1F1A14, 0xFF2A241A, 0xFF3A3225, 0xFF1A1610},
       Texture::bakeliteMottle,
       0.060f,
       24.0f},
      {Flavor::ConsoleCool,
       Mode::Dark,
       {0xFF15181B, 0xFF1C2024, 0xFF262B30, 0xFF353C42, 0xFF181B1E},
